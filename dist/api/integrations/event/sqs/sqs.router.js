...
class SqsRouter extends abstract_router_1.RouterBroker {
    constructor(...guards) {
        super();
        ...
        this.router
            ...
            const response = await this.dataValidate({
                ...
                execute: (instance, data) => server_module_1.eventManager.sqs.set(instance.instanceName, data),
            });
            ...
            const response = await this.dataValidate({
                ...
                execute: (instance) => server_module_1.eventManager.sqs.get(instance.instanceName),
            });
            res.status(index_router_1.HttpStatus.OK).json(response);
        });
    }
}
exports.SqsRouter = SqsRouter;
