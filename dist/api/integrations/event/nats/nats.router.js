...
class NatsRouter extends abstract_router_1.RouterBroker {
    constructor(...guards) {
        super();
        ...
        this.router
            ...
            const response = await this.dataValidate({
                request: req,
                schema: validate_schema_1.eventSchema,
                ClassRef: event_dto_1.EventDto,
                execute: (instance, data) => server_module_1.eventManager.nats.set(instance.instanceName, data),
            });
            ...
            const response = await this.dataValidate({
                ...
                execute: (instance) => server_module_1.eventManager.nats.get(instance.instanceName),
            });
            res.status(index_router_1.HttpStatus.OK).json(response);
        });
    }
}
exports.NatsRouter = NatsRouter;
