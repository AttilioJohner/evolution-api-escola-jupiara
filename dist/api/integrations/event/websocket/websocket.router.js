...
class WebsocketRouter extends abstract_router_1.RouterBroker {
    constructor(...guards) {
        super();
        ...
        this.router
            ...
            const response = await this.dataValidate({
                ...
                execute: (instance, data) => server_module_1.eventManager.websocket.set(instance.instanceName, data),
            });
            ...
            const response = await this.dataValidate({
                ...
                execute: (instance) => server_module_1.eventManager.websocket.get(instance.instanceName),
            });
