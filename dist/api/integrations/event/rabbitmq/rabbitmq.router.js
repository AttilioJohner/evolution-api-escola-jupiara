    ...
    constructor(...guards) {
        ...
        this.router
            ...
            const response = await this.dataValidate({
                ...
                execute: (instance, data) => server_module_1.eventManager.rabbitmq.set(instance.instanceName, data),
            });
            ...
            const response = await this.dataValidate({
                ...
                execute: (instance) => server_module_1.eventManager.rabbitmq.get(instance.instanceName),
            });
