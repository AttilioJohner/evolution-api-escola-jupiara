...
const settings_dto_1 = require("@api/dto/settings.dto");
    ...
    constructor(...guards) {
        ...
        this.router
            ...
            const response = await this.dataValidate({
                ...
                execute: (instance, data) => server_module_1.settingsController.createSettings(instance, data),
            });
            ...
            const response = await this.dataValidate({
                ...
                execute: (instance) => server_module_1.settingsController.findSettings(instance),
            });
